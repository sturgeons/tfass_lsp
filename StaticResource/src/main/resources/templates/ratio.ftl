	...
	<head>
  	...
  	<body>
		<div id='root' class="container-fluid"></div>
  		...
  		<script src="javascript/views/frond/ratio/vendor.4c29ec88131fd1103a1c.js"></script>
  		<script src="javascript/views/frond/ratio/bootstrap.4c29ec88131fd1103a1c.js"></script>
  		<script src="javascript/views/frond/ratio/main.4c29ec88131fd1103a1c.js"></script>
	</body>
</html>
